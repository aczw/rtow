...
std::optional<ScatterResult> DieletricMaterial::scatter(const Ray& ray_in, const Intersection& isect) const {
  ...
  Vec3 incoming_ray_direction = ray_in.get_direction().normalized();
