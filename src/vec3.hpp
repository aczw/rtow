...
class Vec3 {
 ...
 public:
  ...
  /// Refracts an incoming `vector` using `normal` as a frame of reference. The direction of `normal`
  /// should be perpendicular to the initial and final material's surface. It's assumed the two materials
  /// meet each other at a straight line.
